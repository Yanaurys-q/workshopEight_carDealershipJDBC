...
public class SalesContract {
    ...
    public SalesContract(int id,String vin,String customer,double amount,LocalDate date){
        this.id=id;this.vin=vin;this.customer=customer;this.amount=amount;this.date=date;
    }
    public SalesContract(String vin,String customer,double amount,LocalDate date){this(0,vin,customer,amount,date);}
